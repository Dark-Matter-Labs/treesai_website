  ...
  return (
    <section className='bg-green2' id='testimonials'>
      <div className='text-center mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl heading-padd'>
        <p className='font-grotesk mt-2 text-3xl text-gray sm:text-4xl'>Testimonials</p>
      </div>
        ...
        <div className='py-12 px-4 sm:px-6 md:flex md:flex-col md:py-16 md:pl-0 md:pr-10 lg:pr-16'>
          <blockquote className='mt-6 md:flex-grow md:flex md:flex-col'>
            <div className='relative text-lg font-medium text-white md:flex-grow google-text'>
              ...
              <a href='https://www.google.org/' target='_blank' rel='noreferrer noopener'>
            ...
            <footer className='mt-8'>
              <div className='flex items-start'>
                <div>
                  <div className='text-base font-medium text-white'>Google.org</div>
        ...
        <div className='py-12 px-4 sm:px-6 md:py-16 md:pr-0 md:pl-10 lg:pl-16'>
          <blockquote className='mt-6 md:flex-grow md:flex md:flex-col'>
            <div className='relative text-lg font-medium text-white md:flex-grow'>
              ...
              <a href='https://www.glasgow.gov.uk/' target='_blank' rel='noreferrer noopener'>
            ...
            <footer className='mt-8'>
              <div className='md:flex-shrink-0'>
                <a
                  ...
                  rel='noreferrer noopener'
                >
                  <img className='h-28' src={glasgowLogo} alt='City of Glasgow logo' />
                </a>
              </div>
              <div className='flex items-start'>
                <div className='pt-8'>
                  <div className='text-base font-medium text-white'>Susan Aitken</div>
                  <div className='text-base font-medium text-green1'>
