...
const councilFeatures = [
  ...
  },
  {
    ...
    plus: false,
    description: 'AI-backed modelling enables near real-time environmental impact assessments.',
    icon: CashFlowIcon,
  },
  {
    name: 'Plan and forecast climate targets',
    plus: false,
    description: 'Digital contracting mechanisms reduce cumbersome bureaucratic processes.',
    icon: GoalsIcon,
  },
];
