      ...
      <div className="m-20 grid grid-cols-1 gap-1 md:grid-cols-1 sm:grid-cols-1 lg:grid-cols-2">
        <div className="py-12 bg-white" id="products">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10">
              <dl className="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:gap-x-10 sm:gap-y-10 lg:mt-0 lg:col-span-2">
        ...
        <div className="py-12-edit bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10">
              <dl className="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2">
