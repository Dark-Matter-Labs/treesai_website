        ...
        <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="">
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              At TreesAI, accessible from https://treesasinfrastructure.com/,
              one of our main priorities is the privacy of our visitors. This
              Privacy Policy document contains types of information that is
              collected and recorded by TreesAI and how we use it.
            </p>
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              ...
              that they shared and/or collect in TreesAI. This policy is not
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              TreesAI follows a standard procedure of using log files. These
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              Like any other website, TreesAI uses 'cookies'. These cookies are
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              TreesAI does not knowingly collect any Personal Identifiable
