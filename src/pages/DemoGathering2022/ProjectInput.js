...
export default function ProjectInput() {
  ...
  const [avgCarbonReleasePlot, setAvgCarbonReleasePlot] = useState("");
  const [avgCarbonSequestPlot, setAvgCarbonSequestPlot] = useState("");
  const [treeHealthPlot, setTreeHealthPlot] = useState("");
